		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices App",
									"targetURL": "#invoicesinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicesinvoices-display": {
								"semanticObject": "invoicesinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoices.invoices",
									"url": sap.ui.require.toUrl("invoices/invoices")
								}
							}
						}
					}
